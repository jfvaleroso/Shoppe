    ...
    $.fn.birthdaypicker = function(options) {
        ...
        return this.each(function() {
            ...
            var $fieldset = $("<fieldset class='birthday-picker'></fieldset>"),
                $year = $("<select class='birth-year combobox combobox-medium' name='birth[year]'></select>"),
                $month = $("<select class='birth-month combobox combobox-medium' name='birth[month]'></select>"),
                $day = $("<select class='birth-day combobox combobox-medium' name='birth[day]'></select>");
