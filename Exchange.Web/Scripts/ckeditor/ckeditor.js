    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            buildStyleHtml: function(b) {
                for (var b = [].concat(b), a, d = [], h = 0; h < b.length; h++)if (a = b[h])/@
                import | [{}] / .;
                ...
                if (a && a.isInline()) {
                    ...
                    if (c = this.ui.space(this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? "top" : "contents")) {
                        var e = CKEDITOR.tools.getNextId(),
                            d = CKEDITOR.dom.element.createFromHtml('<span id="' + e + '" class="cke_voice_label">' + this.lang.Base.editorHelp +
                                "</span>");
                        c.append(d);
...
*/
    ...
    (function() {
        ...
        function R(a) {
            var a = CKEDITOR.dom.element.createFromHtml(CKEDITOR.addTemplate("dialog", S).output({ id: CKEDITOR.tools.getNextNumber(), editorId: a.id, langDir: a.lang.dir, langCode: a.langCode, editorDialogClass: "cke_editor_" + a.name.replace(/\./g, "\\.") + "_dialog", closeTitle: a.lang.Base.close, hidpi: CKEDITOR.env.hidpi ? "cke_hidpi" : "" })), b = a.getChild([0, 0, 0, 0, 0]), c = b.getChild(0), e = b.getChild(1);
        ...
        function V(a) {
            ...
            if (f != CKEDITOR.DIALOG_RESIZE_NONE) {
                ...
                a.on("load", function() {
                    ...
                    b = CKEDITOR.dom.element.createFromHtml('<div class="cke_resizer' + b + " cke_resizer_" + i.lang.dir + '" title="' + CKEDITOR.tools.htmlEncode(i.lang.Base.resize) +
        ...
        CKEDITOR.dialog = function(a, b) {
            ...
            this.on("cancel", function(b) {
                p(function(c) {
                    if (c.isChanged())
                        return!a.config.dialog_noConfirmCancel && !confirm(a.lang.Base.confirmCancel) &&
                        (b.data.hide = !1), !0;
                });
            }, this, null, 0);
            ...
            if (!1 !== a.resize_enabled) {
                ...
                b.on("uiSpace", function(a) {
                    if ("bottom" ==
                        ...
                        var c = '<span id="' + q + '" class="cke_resizer' + e + " cke_resizer_" + h + '" title="' + CKEDITOR.tools.htmlEncode(b.lang.Base.resize) + '" onmousedown="CKEDITOR.tools.callFunction(' + p + ', event)">' + ("ltr" == h ? "◢" : "◣") + "</span>";
        ...
        CKEDITOR.plugins.add("wysiwygarea", {
            init: function(a) {
                ...
                a.addMode("wysiwyg", function(d) {
                    ...
                    var f = a.title, h = a.lang.Base.editorHelp;
        ...
        CKEDITOR.plugins.add("image", {
            ...
            init: function(b) {
                if (!b.plugins.image2) {
                    ...
                    b.ui.addButton && b.ui.addButton("Image", { label: b.lang.Base.image, command: "image", toolbar: "insert,10" });
    ...
    CKEDITOR.plugins.add("menubutton", {
        ...
        onLoad: function() {
            var d = function(c) {
                ...
                a.state !== CKEDITOR.TRISTATE_DISABLED && (a.on && b ? b.hide() : (a.previousState = a.state, b || (b = a.menu = new CKEDITOR.menu(c, { panel: { className: "cke_menu_panel", attributes: { "aria-label": c.lang.Base.options } } }), b.onHide = CKEDITOR.tools.bind(function() {
