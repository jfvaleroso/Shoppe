                            ...
                            children: [
                                {
                                    ...
                                    children: [
                                        ...
                                        }, { id: "cmbAlign", type: "select", requiredContent: "table[align]", "default": "", label: a.lang.Base.align, items: [[a.lang.Base.notSet, ""], [a.lang.Base.alignLeft, "left"], [a.lang.Base.alignCenter, "center"], [a.lang.Base.alignRight, "right"]], setup: function(a) { this.setValue(a.getAttribute("align") || ""); }, commit: function(a, d) { this.getValue() ? d.setAttribute("align", this.getValue()) : d.removeAttribute("align"); } }
                                    ]
                                },
                                {
                                    type: "vbox",
                                            ...
                                            children: [
                                                {
                                                    ...
                                                    controlStyle: "width:5em",
                                                    label: a.lang.Base.width,
                                                    title: a.lang.Base.cssLengthTooltip,
                                                    "default": a.filter.check("table{width}") ? 500 > n.getSize("width") ? "100%" : 500 : 0,
                                                    getValue: q,
                                                    validate: CKEDITOR.dialog.validate.cssLength(a.lang.Base.invalidCssLength.replace("%1", a.lang.Base.width)),
                                                    onChange: function() {
                                            ...
                                            children: [
                                                {
                                                    ...
                                                    controlStyle: "width:5em",
                                                    label: a.lang.Base.height,
                                                    title: a.lang.Base.cssLengthTooltip,
                                                    "default": "",
                                                    getValue: q,
                                                    validate: CKEDITOR.dialog.validate.cssLength(a.lang.Base.invalidCssLength.replace("%1", a.lang.Base.height)),
                                                    onChange: function() {
                                                        var a = this.getDialog().getContentElement("advanced", "advStyles");
