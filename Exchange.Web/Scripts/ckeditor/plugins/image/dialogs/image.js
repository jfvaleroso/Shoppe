            ...
            contents: [
                {
                            ...
                            children: [
                                {
                                    ...
                                    children: [
                                        ...
                                        }, { type: "button", id: "browse", style: "display:inline-block;margin-top:10px;", align: "center", label: c.lang.Base.browseServer, hidden: !0, filebrowser: "info:txtUrl" }
                                    ]
                                }
                            ]
                        }, {
                                                    ...
                                                    children: [
                                                        {
                                                            ...
                                                            id: "txtHeight",
                                                            width: "45px",
                                                            label: c.lang.Base.height,
                                                            onKeyUp: w,
                                                            onChange: function() { i.call(this, "advanced:txtdlgGenStyle"); },
                                                            validate: function() {
                                                                var a = this.getValue().match(v);
                                                                (a = !!(a && 0 !== parseInt(a[1], 10))) || alert(c.lang.Base.invalidHeight);
                                                                return a;
                                                            },
                                                            setup: y,
                                                            commit: function(a, b, d) {
                                            ...
                                            children: [
                                                {
                                                    ...
                                                    widths: ["35%", "65%"],
                                                    style: "width:90px",
                                                    label: c.lang.Base.align,
                                                    "default": "",
                                                    items: [[c.lang.Base.notSet, ""], [c.lang.Base.alignLeft, "left"], [c.lang.Base.alignRight, "right"]],
                                                    onChange: function() {
                                                        g(this.getDialog());
                                    ...
                                    children: [
                                        {
                                            ...
                                            id: "htmlPreview",
                                            style: "width:95%;",
                                            html: "<div>" + CKEDITOR.tools.htmlEncode(c.lang.Base.preview) + '<br><div id="' + m + '" class="ImagePreviewLoader" style="display:none"><div class="loading">&nbsp;</div></div><div class="ImagePreviewBox"><table><tr><td><a href="javascript:void(0)" target="_blank" onclick="return false;" id="' +
                    ...
                    elements: [
                        ...
                        }, { type: "button", id: "browse", filebrowser: { action: "Browse", target: "Link:txtUrl", url: c.config.filebrowserImageBrowseLinkUrl }, style: "float:right", hidden: !0, label: c.lang.Base.browseServer }, {
                            id: "cmbTarget",
                            type: "select",
                            requiredContent: "a[target]",
                            label: c.lang.Base.target,
                            "default": "",
                            items: [[c.lang.Base.notSet, ""], [c.lang.Base.targetNew, "_blank"], [c.lang.Base.targetTop, "_top"], [c.lang.Base.targetSelf, "_self"], [c.lang.Base.targetParent, "_parent"]],
                            setup: function(a, b) {
                    ...
                    id: "advanced",
                    label: c.lang.Base.advancedTab,
                    elements: [
                        {
                            type: "hbox",
                            widths: ["50%", "25%", "25%"],
                            children: [
                                { type: "text", id: "linkId", requiredContent: "img[id]", label: c.lang.Base.id, setup: function(a, b) { a == f && this.setValue(b.getAttribute("id")); }, commit: function(a, b) { a == f && (this.getValue() || this.isChanged()) && b.setAttribute("id", this.getValue()); } }, {
                                    id: "cmbLangDir",
                                    type: "select",
                                    requiredContent: "img[dir]",
                                    style: "width : 100px;",
                                    label: c.lang.Base.langDir,
                                    "default": "",
                                    items: [[c.lang.Base.notSet, ""], [c.lang.Base.langDirLtr, "ltr"], [c.lang.Base.langDirRtl, "rtl"]],
                                ...
                                }, { type: "text", id: "txtLangCode", requiredContent: "img[lang]", label: c.lang.Base.langCode, "default": "", setup: function(a, b) { a == f && this.setValue(b.getAttribute("lang")); }, commit: function(a, b) { a == f && (this.getValue() || this.isChanged()) && b.setAttribute("lang", this.getValue()); } }
                            ]
                        }, {
                            type: "text",
                            id: "txtGenLongDescr",
                            requiredContent: "img[longdesc]",
                            label: c.lang.Base.longDescr,
                            ...
                            widths: ["50%", "50%"],
                            children: [
                                { type: "text", id: "txtGenClass", requiredContent: "img(cke-xyz)", label: c.lang.Base.cssClass, "default": "", setup: function(a, b) { a == f && this.setValue(b.getAttribute("class")); }, commit: function(a, b) { a == f && (this.getValue() || this.isChanged()) && b.setAttribute("class", this.getValue()); } }, {
                                    type: "text",
                                    id: "txtGenTitle",
                                    requiredContent: "img[title]",
                                    label: c.lang.Base.advisoryTitle,
                                    "default": "",
                                    onChange: function() { g(this.getDialog()); },
                            ...
                            label: c.lang.Base.cssStyle,
                            validate: CKEDITOR.dialog.validate.inlineStyle(c.lang.Base.invalidInlineStyle),
                            "default": "",
                            setup: function(a,
                                b) {
                                if (a == f) {
