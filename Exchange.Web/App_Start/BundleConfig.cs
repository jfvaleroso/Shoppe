...
namespace Exchange.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(
                new StyleBundle("~/Content/main/css").Include("~/Content/main/main.css")
                    .Include("~/Content/main/basic.css")
                );

            bundles.Add(
                new StyleBundle("~/Content/bootstrap/css").Include("~/Content/bootstrap/bootstrap.css")
            ...
            bundles.Add(new ScriptBundle("~/bundles/bootstrap").Include(
                ...
                .Include("~/Scripts/bootstrap/bootstrap3-typeahead.js"));

            bundles.Add(new ScriptBundle("~/bundles/bootstrap.datetime").Include(
                "~/Scripts/bootstrap.datetime/bootstrap-datetimepicker.min.js")
                .Include("~/Scripts/bootstrap.datetime/daterangepicker.js")
